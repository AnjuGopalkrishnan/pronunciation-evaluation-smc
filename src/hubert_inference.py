...
def get_hubert_asr_sb_object(hparams_file):
    ...
    print("Hubert model object is created with label encoder")
    return asr_brain

# Uncomment for testing locally
if __name__ == '__main__':
    hubert_asr = get_hubert_asr_sb_object('./ml/config/hubert/hparams/train.yaml')
    ...
    predicted_phonemes, score, stats = hubert_asr.evaluate_test_audio(test_audio_path, canonical_phonemes)
    print("Done local testing")

    '''
    Getting run time error when testing locally:
    ...
    This was not the case in colab therefore ignoring this model
    '''